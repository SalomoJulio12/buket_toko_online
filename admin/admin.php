                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <?php if($d['admin_id'] != 1){ ?>
                          <a class="btn btn-danger btn-sm" href="#" onclick="confirmDelete(<?php echo $d['admin_id']; ?>)"><i class="fa fa-trash"></i></a>
                        <?php } ?>
                      </td>
                    </tr>
                    <?php 
...
<script type="text/javascript">
  function confirmDelete(adminId) {
    var confirmAction = confirm("Apakah anda yakin menghapus admin ini?");
    if (confirmAction) {
      window.location.href = "admin_hapus.php?id=" + adminId;
    }
  }
</script>
