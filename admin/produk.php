                  ...
                  while($d = mysqli_fetch_array($data)) {
                    ...
                    <tr>
                      ...
                      <td>                        
                        ...
                        <a class="btn btn-danger btn-sm" href="javascript:void(0);" onclick="confirmDelete(<?php echo $d['produk_id']; ?>)"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php 
                  }
...
<script type="text/javascript">
  function confirmDelete(id) {
    ...
    if (confirm("Apakah Anda yakin ingin menghapus produk ini?")) {
      // Jika pengguna mengonfirmasi, lakukan penghapusan dengan mengarahkan ke halaman produk_hapus.php
