            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  <?php 
                  $no = 1;
                  // Menggunakan alias tabel untuk menghindari ambiguitas
                  $invoice = mysqli_query($koneksi, "
                    SELECT * FROM invoice AS i
                    JOIN customer AS c ON i.invoice_customer = c.customer_id
                  ...
                  while ($i = mysqli_fetch_array($invoice)) {
                    ...
                    <tr>
                      ...
                      <td><?php echo "Rp. ".number_format($i['total_bayar'])." ,-" ?></td>
                      ...
                      <td class="text-center">    
                        ...
                        <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="confirmDelete(<?php echo $i['invoice_id']; ?>)"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php 
                  }
...
<script type="text/javascript">
  function confirmDelete(id) {
    ...
    if (confirm("Apakah Anda yakin ingin menghapus transaksi ini?")) {
      // Jika pengguna mengonfirmasi, lakukan penghapusan dengan mengarahkan ke halaman transaksi_hapus.php
