			...
			<div class="col-md-12">
				<form method="post" action="keranjang_update.php">
					<div class="order-summary clearfix">
						...
						<form method="POST" action="keranjang_masukkanthree.php">
							<input type="hidden" name="produk_id" value="<?php echo $produk_id; ?>" />
							<input type="hidden" name="harga" value="<?php echo $harga; ?>" />
							<input type="hidden" name="jumlah_produk" value="<?php echo $jumlah_produk; ?>" />
							...
							echo "<br><br><br><h3><center>Keranjang Masih Kosong. Yuk <a href='index.html'>belanja</a> !</center></h3><br><br><br>";
						}
					}else{
						echo "<br><br><br><h3><center>Keranjang Masih Kosong. Yuk <a href='index.html'>belanja</a> !</center></h3><br><br><br>";
					}
